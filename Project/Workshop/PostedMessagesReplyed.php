...
<br /><br /><br />
  ...
  <th width="166">ServiceCentre</td>
    ...
    <?php
   		 	$Selquery="select * from tbl_servicerequest  p inner join  tbl_user t on p.user_id=t.user_id inner join tbl_servicerate s on s.service_id=p.service_id inner join tbl_servicetype st on st.servicetype_id=s.servicetype_id where p.request_status='1' and s.workshop_id='".$_SESSION["uid"]."'";
