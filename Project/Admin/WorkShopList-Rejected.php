...
<body>
 ...
 <table width="726" height="102" border="1" align="center">
    <tr>
      <td>SI No</td>
      <td>District</td>
      <td>Place</td>
    ...
    <?php
	$i=0;
	$selquery="select * from tbl_workshop w inner join tbl_place p on w.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where w.workshop_status='2'";
