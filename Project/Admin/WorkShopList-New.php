<?php
	...
	if($_GET["ac"])
	{
		$ace="update tbl_workshop set workshop_status='1' where workshop_id='".$_GET["ac"]."'";
		mysql_query($ace);
	}
...
<body>
 ...
 <table width="743" height="102" border="1" align="center">
    <tr>
      <td>SI No</td>
      <td>District</td>
      <td>Place</td>
    ...
    <?php
	$i=0;
	$selquery="select * from tbl_workshop w inner join tbl_place p on w.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where w.workshop_status='0'";
	...
	while($data=mysql_fetch_array($row))
    {
         ...
         <td><?php echo $data["workshop_doj"];?></td>
          ...
          <td> <a href="WorkShopList-New.php?ac=<?php echo $data["workshop_id"];?>">Accept</a></td>
